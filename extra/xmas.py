...
questions: Dict[str, List[Dict[str, str]]] = {
	"all": [
		...
		{"question": "The japanese word for bread is パン (PAN), it has origin in what language?", "answer": "Portuguese"},
		...
		{"question": "In what country is the pirahã language spoken?", "answer": "Brazil"},
		...
		{"question": """Combining the words "σχίζειν" — “to split” and "φρην" — “mind” you get this english word's etymology.""", "answer": "Schizophrenia"},
		...
		{"question": """This english word comes from a misheard pronounciation of Spanish "el lagarto" - ‘the lizard'""", "answer": "Alligator"},
		{"question": """Anglicization of the spanish word "cucaracha".""", "answer": "Cockroach"},
		{"question": """Food, literally translated as “little donkey”.""", "answer": "Burrito"},
		{"question": """Food, literally translated as "strained pineapple".""", "answer": "piña colada"},
		...
		{"question": """Word from Dutch koekje ‘little cake’""", "answer": "Cookie"}
	]
}
